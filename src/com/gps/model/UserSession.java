  ...
  implements Serializable
{
  ...
  public UserSession(Integer id, Integer userid, String session, String clientIP, Integer port, Integer type, String usrSvrIdno, Integer status, Date updateTime)
  {
    this.id = id;
    this.userid = userid;
