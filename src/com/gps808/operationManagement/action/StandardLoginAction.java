  ...
  extends StandardUserBaseAction
{
  ...
  public String login()
  {
    try
    {
      ...
      if (userAccount == null)
      {
//        userService.addUserLog(null, Integer.valueOf(1), Integer.valueOf(5), null, request.getRemoteAddr(), account, password, null);
        addCustomResponse(ACTION_RESULT, Integer.valueOf(1));
      }
      ...
      {
//        userService.addUserLog(userAccount.getId(), Integer.valueOf(1), Integer.valueOf(5), null, request.getRemoteAddr(), userAccount.getAccount(), password, null);
